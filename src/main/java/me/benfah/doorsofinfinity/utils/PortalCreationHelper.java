...
public class PortalCreationHelper {
	public static Portal spawn(World world, Vec3d pos, double width, double height, Vec3i axisW, Vec3i axisH, RegistryKey<World> dimensionTo, Vec3d dest, boolean teleportable, Quaternion rot, boolean biWay) {
		...
		portal(width, height, axisW, axisH, dimensionTo, dest, teleportable, portal);
	...
	private static void portal(double width, double height, Vec3i axisW, Vec3i axisH, RegistryKey<World> dimensionTo, Vec3d dest, boolean teleportable, Portal portal) {
		portal.width = width;
